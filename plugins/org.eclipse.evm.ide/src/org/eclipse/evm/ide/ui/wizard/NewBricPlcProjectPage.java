...
public class NewBricPlcProjectPage extends WizardNewProjectCreationPage {
	 ...
	 */
	public NewBricPlcProjectPage(String pageName) {
		super(pageName);
	...
	public void createControl(Composite parent) {
		...
		applicationName = new InitialNameGroup((Composite) getControl(), Messages.New4diacProjectWizard_InitialApplicationName);
